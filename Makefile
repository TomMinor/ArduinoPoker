...
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -o Makefile CardExample.pro
#############################################################################
...
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-g++ -I. -Iinclude -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtCore -I.
LINK          = g++
...
Makefile: CardExample.pro .qmake.cache /opt/Qt/5.3/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile CardExample.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) obj/CardExample1.0.0/ && $(COPY_FILE) --parents include/card.h include/dealer/playingcard.h obj/CardExample1.0.0/ && $(COPY_FILE) --parents src/examples/cardUsage.cpp src/dealer/card.cpp obj/CardExample1.0.0/ && (cd `dirname obj/CardExample1.0.0` && $(TAR) CardExample1.0.0.tar CardExample1.0.0 && $(COMPRESS) CardExample1.0.0.tar) && $(MOVE) `dirname obj/CardExample1.0.0`/CardExample1.0.0.tar.gz . && $(DEL_FILE) -r obj/CardExample1.0.0
...
obj/card.o: src/dealer/card.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/card.o src/dealer/card.cpp
