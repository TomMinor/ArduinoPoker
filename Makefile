#############################################################################
# Makefile for building: dealerLib
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  dealerLib.pro
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile dealerLib.pro
#############################################################################
...
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-clang -I. -Iinclude -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtGui -I/opt/Qt/5.3/gcc_64/include/QtCore -I.
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/Qt/5.3/gcc_64 -Wl,-rpath,/opt/Qt/5.3/gcc_64/lib
LIBS          = $(SUBLIBS) -L/opt/Qt/5.3/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/dealer/dealerLib.cpp \
		src/dealer/deck.cpp \
		src/dealer/playingcard.cpp \
		src/dealer/player.cpp \
		src/dealer/dealerLibMain.cpp 
OBJECTS       = dealerLib.o \
		deck.o \
		playingcard.o \
		player.o \
		dealerLibMain.o
DIST          = .qmake.cache \
		dealerLib.pro src/dealer/dealerLib.cpp \
		src/dealer/deck.cpp \
		src/dealer/playingcard.cpp \
		src/dealer/player.cpp \
		src/dealer/dealerLibMain.cpp
QMAKE_TARGET  = dealerLib
...
Makefile: dealerLib.pro .qmake.cache /opt/Qt/5.3/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile dealerLib.pro
...
dist: 
	@test -d .tmp/dealerLib1.0.0 || mkdir -p .tmp/dealerLib1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/dealerLib1.0.0/ && $(COPY_FILE) --parents include/card.h include/dealer/dealerLib.h include/dealer/deck.h include/dealer/playingcard.h include/dealer/player.h .tmp/dealerLib1.0.0/ && $(COPY_FILE) --parents src/dealer/dealerLib.cpp src/dealer/deck.cpp src/dealer/playingcard.cpp src/dealer/player.cpp src/dealer/dealerLibMain.cpp .tmp/dealerLib1.0.0/ && (cd `dirname .tmp/dealerLib1.0.0` && $(TAR) dealerLib1.0.0.tar dealerLib1.0.0 && $(COMPRESS) dealerLib1.0.0.tar) && $(MOVE) `dirname .tmp/dealerLib1.0.0`/dealerLib1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dealerLib1.0.0
...
dealerLib.o: src/dealer/dealerLib.cpp include/dealer/dealerLib.h \
		include/dealer/player.h \
		include/dealer/playingcard.h \
		include/card.h \
		include/dealer/deck.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dealerLib.o src/dealer/dealerLib.cpp

deck.o: src/dealer/deck.cpp include/dealer/deck.h \
		include/dealer/playingcard.h \
		include/card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o deck.o src/dealer/deck.cpp

playingcard.o: src/dealer/playingcard.cpp include/dealer/playingcard.h \
		include/card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o playingcard.o src/dealer/playingcard.cpp

player.o: src/dealer/player.cpp include/dealer/player.h \
		include/dealer/playingcard.h \
		include/card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o player.o src/dealer/player.cpp

dealerLibMain.o: src/dealer/dealerLibMain.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dealerLibMain.o src/dealer/dealerLibMain.cpp
