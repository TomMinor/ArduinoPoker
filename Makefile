...
# Project:  sketchbook/libraries/player/player.pro
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile sketchbook/libraries/player/player.pro
#############################################################################
...
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-clang -Isketchbook/libraries/player -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtGui -I/opt/Qt/5.3/gcc_64/include/QtCore -I. -I.
LINK          = clang++
...
SOURCES       = sketchbook/libraries/player/player.cpp 
OBJECTS       = player.o
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		sketchbook/libraries/player/sketchbook/libraries/player/player.pro sketchbook/libraries/player/player.cpp
QMAKE_TARGET  = player
...
Makefile: sketchbook/libraries/player/player.pro /opt/Qt/5.3/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/5.3/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/features/lex.prf \
		sketchbook/libraries/player/player.pro \
		/opt/Qt/5.3/gcc_64/lib/libQt5Gui.prl \
		/opt/Qt/5.3/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile sketchbook/libraries/player/player.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/player1.0.0/ && $(COPY_FILE) --parents sketchbook/libraries/player/player.h .tmp/player1.0.0/ && $(COPY_FILE) --parents sketchbook/libraries/player/player.cpp .tmp/player1.0.0/ && (cd `dirname .tmp/player1.0.0` && $(TAR) player1.0.0.tar player1.0.0 && $(COMPRESS) player1.0.0.tar) && $(MOVE) `dirname .tmp/player1.0.0`/player1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/player1.0.0
...
player.o: sketchbook/libraries/player/player.cpp sketchbook/libraries/player/player.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o player.o sketchbook/libraries/player/player.cpp
