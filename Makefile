...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/winner1.0.0/ && $(COPY_FILE) --parents include/card.h include/dealer/deck.h include/dealer/playingcard.h include/dealer/player.h include/dealer/pokerHands.h .tmp/winner1.0.0/ && $(COPY_FILE) --parents src/dealer/main.cpp src/dealer/deck.cpp src/dealer/playingcard.cpp src/dealer/player.cpp src/dealer/pokerHands.cpp .tmp/winner1.0.0/ && (cd `dirname .tmp/winner1.0.0` && $(TAR) winner1.0.0.tar winner1.0.0 && $(COMPRESS) winner1.0.0.tar) && $(MOVE) `dirname .tmp/winner1.0.0`/winner1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/winner1.0.0
