...
//-----------------------------------------------------------------------------------------------------------------------------
    ...
    void flush(player &_player, const std::vector<PlayingCard> &_river);  //ONLY 11 // SCORE 128-140 | 13 different valued flushes, containing Ace being the highest value
