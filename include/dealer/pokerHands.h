...
//-----------------------------------------------------------------------------------------------------------------------------
    ...
    void pair(player &_player, const std::vector<PlayingCard> &_river);             // SCORE 14-26   | 13 different valued pairs, Ace,Ace being the higest.
    void twoPair(player &_player, const std::vector<PlayingCard> &_river);          // SCORE 27-104  | 78 different valued 2 pairs, Ace,Ace,King,King being the highest.
...
//-----------------------------------------------------------------------------------------------------------------------------
    ...
    void winner(const int &_numPlayers, std::vector<player> &_livePlayers, const std::vector<PlayingCard> &_river);
