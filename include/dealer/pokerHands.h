...
/// @namespace hands encapsulates all methods used to find players best hand and decide winner of Poker.
namespace hands
{
//-----------------------------------------------------------------------------------------------------------------------------
    // Evaluate hands methods
//-----------------------------------------------------------------------------------------------------------------------------
    /// @brief method to find spare cards not already being used in players hand, the cards in the stack returned are not ordered.
    /// @param [in] const Player
    /// @param [in] const cardStack this is the river (community cards))
